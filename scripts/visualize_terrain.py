...
def main():
  ...
  # Load available terrains from config and custom complex terrains.
  from src.tasks.velocity.terrains import get_complex_outdoor_terrain_cfg
  complex_sub_terrains = get_complex_outdoor_terrain_cfg().sub_terrains
  available_presets = {**ALL_TERRAINS_CFG.sub_terrains, **complex_sub_terrains}
